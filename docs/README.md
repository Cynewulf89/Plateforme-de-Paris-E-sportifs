...
L'application sera disponible sur [http://localhost:5173](http://localhost:5173), backend sur http://localhost:3002.
...
2. **Créez un nouveau projet** :
   ...
   - Repository : Votre repository GitHub (ex: `username/plateforme-esports`)
   - Branch : `dev` (ou `main`)
